...
## Overview
This program implements a simple doubly linked list with only two operations: insert after a given node and delete a node. It demonstrates how nodes can be inserted or removed while maintaining both forward and backward links.
...
- Purpose: Deletes a node with a given data value.
...
4. Delete node with data 30 (tail)
5. Insert 15 after the current head
